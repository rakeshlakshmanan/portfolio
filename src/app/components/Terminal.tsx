...
const COMMANDS: Record<string, () => string[]> = {
  ...
  projects: () => [
    "▸ SmartEnoughCity",
    "  Cloud-native urban transport intelligence platform (4 microservices)",
    "  Stack: Java · Spring Boot · Python · FastAPI · React · GKE · Terraform",
    "",
    "▸ Distributed Traffic Booking System",
    "  Saga-orchestrated cross-region road booking across 3 geo regions",
    "  Stack: Python · FastAPI · PostgreSQL · Redis · RabbitMQ · AWS",
    "",
    "▸ DevVault",
    "  AI-powered developer bookmark manager (Gemini auto-tagging)",
    "  Stack: Java · Spring Boot · PostgreSQL · React · GKE",
    "",
    "▸ EliteCode",
    "  Adaptive interview prep via Bayesian Knowledge Tracing",
    "  Stack: Python · FastAPI · Supabase · Judge0 · React",
    "",
